      ...
      Widget build(BuildContext context) {
        ...
        return Scaffold(
          ...
          body: Container(
            ...
            child: Column(
              children: [
                itemhistory == null?Flexible(
                                  child: Container(
                    alignment: Alignment.center,
                    child: Text(titlecenter,style: TextStyle(color:Colors.grey),),
                  ),
                ):Expanded(
                    ...
                    childAspectRatio: (screenHeight/screenWidth/0.77),
                             ...
                             children: [
                               Expanded(child: Container(
                                 ...
                                 child: CachedNetworkImage( 
                                   imageUrl: server+"/images/${itemhistory[index]['foodimage']}.jpg",
                               ...
                               Text("${dateTime=DateFormat("yyyy-MM-dd hh:mm:ss").parse(itemhistory[index]['date'])}"),
                             ],
                           ), 
                          )),
        ...
        http.post(server+"/php/get_history.php",body:{
          ...
          print(res.body);
            if(res.body=='nohistory'){
              ...
              Toast.show('No record', context,duration: Toast.LENGTH_LONG,gravity: Toast.BOTTOM);
